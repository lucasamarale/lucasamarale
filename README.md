...
I am a Partnerships & Channels Manager at **Life Link**, a technology company in Brasília, and a developer who builds systems with AI and ships them. Python pipelines where Claude classifies and writes, a governed knowledge base over MCP, an n8n chatbot, and websites in vanilla code. At work I deploy and demo what I sell, operate in English alongside a vendor SOC, and negotiate international agreements. Computer Science at UniCEUB (2025-2028), with an exchange at BCIT in Vancouver and a year of high school in New Zealand.
...
| --- | --- | --- |
| **Court Docket Monitor** *(private, for a law firm)* | Tracks around 200 court cases a day: queries the DataJud API and higher courts, detects new activity by SHA-256 hash, classifies it with Claude and notifies through WhatsApp, email and Google Sheets. Circuit breakers per court, outbox pattern, 150+ pytest cases, CI on GitHub Actions. | `Python` `Claude` `pytest` `GitHub Actions` |
| **[nola AI](https://github.com/lucasamarale/nola-ai-chatbot)** | AI support chatbot for a restaurant-management SaaS, from zero to production in 48 hours. | `n8n` `Groq` `LLaMA` |
| **Lucas Brain** | Obsidian vault with a written constitution: typed frontmatter, controlled vocabulary, write zones. Claude works inside it over MCP, and a pipeline (Quill, Whisper, Python, LaunchAgent) turns recorded meetings into classified, linked notes before I open them. | `Python` `Whisper` `MCP` `Obsidian` |
...
- **[dumbfit-academia](https://github.com/lucasamarale/dumbfit-academia)** · Gym management system in PHP and SQLite: REST API over five entities, Chart.js dashboard, PDF reports. University systems-development project.
- **[task-manager-extension](https://github.com/lucasamarale/bootcamp)** · Chrome extension (Manifest V3) with AI suggestions through the Gemini API and one-click save to Google Calendar.
- **[CEUB](https://github.com/lucasamarale/CEUB)** · Computer Science coursework, organized by discipline and delivery.

## Stack

**Languages** ![Python](https://img.shields.io/badge/Python-B45309?style=flat-square&logo=python&logoColor=white) ![JavaScript](https://img.shields.io/badge/JavaScript-B45309?style=flat-square&logo=javascript&logoColor=white) ![HTML5](https://img.shields.io/badge/HTML5-B45309?style=flat-square&logo=html5&logoColor=white) ![CSS](https://img.shields.io/badge/CSS-B45309?style=flat-square&logo=css&logoColor=white) ![PHP](https://img.shields.io/badge/PHP-B45309?style=flat-square&logo=php&logoColor=white) ![Java](https://img.shields.io/badge/Java-B45309?style=flat-square&logo=openjdk&logoColor=white) ![React](https://img.shields.io/badge/React-B45309?style=flat-square&logo=react&logoColor=white)

**AI and knowledge** ![Claude](https://img.shields.io/badge/Claude-B45309?style=flat-square&logo=anthropic&logoColor=white) ![MCP](https://img.shields.io/badge/MCP-B45309?style=flat-square&logo=modelcontextprotocol&logoColor=white) ![n8n](https://img.shields.io/badge/n8n-B45309?style=flat-square&logo=n8n&logoColor=white) ![Whisper](https://img.shields.io/badge/Whisper-B45309?style=flat-square&logo=openai&logoColor=white) ![Obsidian](https://img.shields.io/badge/Obsidian-B45309?style=flat-square&logo=obsidian&logoColor=white)

**Data, testing and platforms** ![SQLite](https://img.shields.io/badge/SQLite-4A3B33?style=flat-square&logo=sqlite&logoColor=white) ![MySQL](https://img.shields.io/badge/MySQL-4A3B33?style=flat-square&logo=mysql&logoColor=white) ![pandas](https://img.shields.io/badge/pandas-4A3B33?style=flat-square&logo=pandas&logoColor=white) ![Playwright](https://img.shields.io/badge/Playwright-4A3B33?style=flat-square&logo=playwright&logoColor=white) ![pytest](https://img.shields.io/badge/pytest-4A3B33?style=flat-square&logo=pytest&logoColor=white) ![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-4A3B33?style=flat-square&logo=githubactions&logoColor=white) ![SharePoint](https://img.shields.io/badge/SharePoint-4A3B33?style=flat-square&logo=microsoftsharepoint&logoColor=white) ![Netlify](https://img.shields.io/badge/Netlify-4A3B33?style=flat-square&logo=netlify&logoColor=white)
